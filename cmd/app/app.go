...
func action(ctx *cli.Context) error {
	...
	go utils.LoopWithContext(subCtx, time.Second*3, l1Watcher.ScanL1Chain)
	go utils.LoopWithContext(subCtx, time.Second*3, l2Watcher.ScanL2Chain)
	go utils.LoopWithContext(subCtx, time.Second, chainMonitor.ChainMonitor)
