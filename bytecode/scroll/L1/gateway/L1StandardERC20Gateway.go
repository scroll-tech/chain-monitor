...
var (
	...
	L1StandardERC20GatewayABI, _ = L1StandardERC20GatewayMetaData.GetAbi()
)
...
func (o *L1StandardERC20Gateway) RegisterUpdateRateLimiter(handler func(vLog *types.Log, data *L1StandardERC20GatewayUpdateRateLimiterEvent) error) {
	_id := o.ABI.Events["UpdateRateLimiter"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L1StandardERC20GatewayUpdateRateLimiterEvent)
		if err := o.L1StandardERC20GatewayCaller.contract.UnpackLog(event, "UpdateRateLimiter", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (_L1StandardERC20Gateway *L1StandardERC20GatewayCaller) RateLimiter(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _L1StandardERC20Gateway.contract.Call(opts, &out, "rateLimiter")
...
func (_L1StandardERC20Gateway *L1StandardERC20GatewayTransactor) UpdateRateLimiter(opts *bind.TransactOpts, _newRateLimiter common.Address) (*types.Transaction, error) {
	return _L1StandardERC20Gateway.contract.Transact(opts, "updateRateLimiter", _newRateLimiter)
}
...
// L1StandardERC20GatewayUpdateRateLimiter represents a UpdateRateLimiter event raised by the L1StandardERC20Gateway contract.
type L1StandardERC20GatewayUpdateRateLimiterEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
