...
type L1ERC20Gateway struct {
	...
	ABI     *abi.ABI       // L1ERC20GatewayABI is the input ABI used to generate the binding from.
...
// GetName return L1ERC20Gateway's Name.
func (o *L1ERC20Gateway) GetName() string {
	return o.Name
}

// GetAddress return L1ERC20Gateway's contract address.
func (o *L1ERC20Gateway) GetAddress() common.Address {
	return o.Address
}

// GetEventName get event name by event hash.
func (o *L1ERC20Gateway) GetEventName(sigHash common.Hash) string {
	return o.topics[sigHash]
}

// GetSigHashes get sig hash list.
func (o *L1ERC20Gateway) GetSigHashes() []common.Hash {
	if len(o.parsers) == 0 {
		return nil
	}
...
func (o *L1ERC20Gateway) ParseLog(vLog *types.Log) (bool, error) {
	_id := vLog.Topics[0]
...
func (o *L1ERC20Gateway) RegisterDepositERC20(handler func(vLog *types.Log, data *L1ERC20GatewayDepositERC20Event) error) {
	_id := o.ABI.Events["DepositERC20"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L1ERC20GatewayDepositERC20Event)
		if err := o.L1ERC20GatewayCaller.contract.UnpackLog(event, "DepositERC20", *log); err != nil {
			return err
		}
		event.Log = log
...
func (o *L1ERC20Gateway) RegisterFinalizeWithdrawERC20(handler func(vLog *types.Log, data *L1ERC20GatewayFinalizeWithdrawERC20Event) error) {
	_id := o.ABI.Events["FinalizeWithdrawERC20"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L1ERC20GatewayFinalizeWithdrawERC20Event)
		if err := o.L1ERC20GatewayCaller.contract.UnpackLog(event, "FinalizeWithdrawERC20", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L1ERC20Gateway) RegisterInitialized(handler func(vLog *types.Log, data *L1ERC20GatewayInitializedEvent) error) {
	_id := o.ABI.Events["Initialized"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L1ERC20GatewayInitializedEvent)
		if err := o.L1ERC20GatewayCaller.contract.UnpackLog(event, "Initialized", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L1ERC20Gateway) RegisterOwnershipTransferred(handler func(vLog *types.Log, data *L1ERC20GatewayOwnershipTransferredEvent) error) {
	_id := o.ABI.Events["OwnershipTransferred"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L1ERC20GatewayOwnershipTransferredEvent)
		if err := o.L1ERC20GatewayCaller.contract.UnpackLog(event, "OwnershipTransferred", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L1ERC20Gateway) RegisterRefundERC20(handler func(vLog *types.Log, data *L1ERC20GatewayRefundERC20Event) error) {
	_id := o.ABI.Events["RefundERC20"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L1ERC20GatewayRefundERC20Event)
		if err := o.L1ERC20GatewayCaller.contract.UnpackLog(event, "RefundERC20", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L1ERC20Gateway) RegisterUpdateRateLimiter(handler func(vLog *types.Log, data *L1ERC20GatewayUpdateRateLimiterEvent) error) {
	_id := o.ABI.Events["UpdateRateLimiter"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L1ERC20GatewayUpdateRateLimiterEvent)
		if err := o.L1ERC20GatewayCaller.contract.UnpackLog(event, "UpdateRateLimiter", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func NewL1ERC20Gateway(address common.Address, backend bind.ContractBackend) (*L1ERC20Gateway, error) {
	...
	sigAbi, err := L1ERC20GatewayMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
	...
	return &L1ERC20Gateway{
		...
		topics:                   topics,
		parsers:                  map[common.Hash]func(log *types.Log) error{},
		L1ERC20GatewayCaller:     L1ERC20GatewayCaller{contract: contract},
		L1ERC20GatewayTransactor: L1ERC20GatewayTransactor{contract: contract},
	}, nil
}
...
func bindL1ERC20Gateway(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(L1ERC20GatewayMetaData.ABI))
	if err != nil {
		return nil, err
	}
...
func (_L1ERC20Gateway *L1ERC20GatewayCaller) RateLimiter(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _L1ERC20Gateway.contract.Call(opts, &out, "rateLimiter")
...
func (_L1ERC20Gateway *L1ERC20GatewayTransactor) UpdateRateLimiter(opts *bind.TransactOpts, _newRateLimiter common.Address) (*types.Transaction, error) {
	return _L1ERC20Gateway.contract.Transact(opts, "updateRateLimiter", _newRateLimiter)
}

// L1ERC20GatewayDepositERC20 represents a DepositERC20 event raised by the L1ERC20Gateway contract.
type L1ERC20GatewayDepositERC20Event struct {
...
type L1ERC20GatewayFinalizeWithdrawERC20Event struct {
	Log *types.Log `json:"-" gorm:"-"`
...
type L1ERC20GatewayInitializedEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
...
type L1ERC20GatewayOwnershipTransferredEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
...
type L1ERC20GatewayRefundERC20Event struct {
	Log *types.Log `json:"-" gorm:"-"`
...
// L1ERC20GatewayUpdateRateLimiter represents a UpdateRateLimiter event raised by the L1ERC20Gateway contract.
type L1ERC20GatewayUpdateRateLimiterEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
