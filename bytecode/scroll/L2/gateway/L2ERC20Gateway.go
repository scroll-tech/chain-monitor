...
func (o *L2ERC20Gateway) ParseLog(vLog *types.Log) (bool, error) {
	_id := vLog.Topics[0]
...
func (o *L2ERC20Gateway) RegisterUpdateRateLimiter(handler func(vLog *types.Log, data *L2ERC20GatewayUpdateRateLimiterEvent) error) {
	_id := o.ABI.Events["UpdateRateLimiter"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L2ERC20GatewayUpdateRateLimiterEvent)
		if err := o.L2ERC20GatewayCaller.contract.UnpackLog(event, "UpdateRateLimiter", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (_L2ERC20Gateway *L2ERC20GatewayCaller) RateLimiter(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _L2ERC20Gateway.contract.Call(opts, &out, "rateLimiter")
...
func (_L2ERC20Gateway *L2ERC20GatewayTransactor) UpdateRateLimiter(opts *bind.TransactOpts, _newRateLimiter common.Address) (*types.Transaction, error) {
	return _L2ERC20Gateway.contract.Transact(opts, "updateRateLimiter", _newRateLimiter)
}
...
// L2ERC20GatewayUpdateRateLimiter represents a UpdateRateLimiter event raised by the L2ERC20Gateway contract.
type L2ERC20GatewayUpdateRateLimiterEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
