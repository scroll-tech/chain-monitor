...
type L2CustomERC20Gateway struct {
	...
	ABI     *abi.ABI       // L2CustomERC20GatewayABI is the input ABI used to generate the binding from.
...
// GetName return L2CustomERC20Gateway's Name.
func (o *L2CustomERC20Gateway) GetName() string {
	return o.Name
}

// GetAddress return L2CustomERC20Gateway's contract address.
func (o *L2CustomERC20Gateway) GetAddress() common.Address {
	return o.Address
}

// GetEventName get event name by event hash.
func (o *L2CustomERC20Gateway) GetEventName(sigHash common.Hash) string {
	return o.topics[sigHash]
}

// GetSigHashes get sig hash list.
func (o *L2CustomERC20Gateway) GetSigHashes() []common.Hash {
	if len(o.parsers) == 0 {
		return nil
	}
...
func (o *L2CustomERC20Gateway) ParseLog(vLog *types.Log) (bool, error) {
	_id := vLog.Topics[0]
...
func (o *L2CustomERC20Gateway) RegisterFinalizeDepositERC20(handler func(vLog *types.Log, data *L2CustomERC20GatewayFinalizeDepositERC20Event) error) {
	_id := o.ABI.Events["FinalizeDepositERC20"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L2CustomERC20GatewayFinalizeDepositERC20Event)
		if err := o.L2CustomERC20GatewayCaller.contract.UnpackLog(event, "FinalizeDepositERC20", *log); err != nil {
			return err
		}
		event.Log = log
...
func (o *L2CustomERC20Gateway) RegisterInitialized(handler func(vLog *types.Log, data *L2CustomERC20GatewayInitializedEvent) error) {
	_id := o.ABI.Events["Initialized"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L2CustomERC20GatewayInitializedEvent)
		if err := o.L2CustomERC20GatewayCaller.contract.UnpackLog(event, "Initialized", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L2CustomERC20Gateway) RegisterOwnershipTransferred(handler func(vLog *types.Log, data *L2CustomERC20GatewayOwnershipTransferredEvent) error) {
	_id := o.ABI.Events["OwnershipTransferred"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L2CustomERC20GatewayOwnershipTransferredEvent)
		if err := o.L2CustomERC20GatewayCaller.contract.UnpackLog(event, "OwnershipTransferred", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L2CustomERC20Gateway) RegisterUpdateRateLimiter(handler func(vLog *types.Log, data *L2CustomERC20GatewayUpdateRateLimiterEvent) error) {
	_id := o.ABI.Events["UpdateRateLimiter"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L2CustomERC20GatewayUpdateRateLimiterEvent)
		if err := o.L2CustomERC20GatewayCaller.contract.UnpackLog(event, "UpdateRateLimiter", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L2CustomERC20Gateway) RegisterUpdateTokenMapping(handler func(vLog *types.Log, data *L2CustomERC20GatewayUpdateTokenMappingEvent) error) {
	_id := o.ABI.Events["UpdateTokenMapping"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L2CustomERC20GatewayUpdateTokenMappingEvent)
		if err := o.L2CustomERC20GatewayCaller.contract.UnpackLog(event, "UpdateTokenMapping", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func (o *L2CustomERC20Gateway) RegisterWithdrawERC20(handler func(vLog *types.Log, data *L2CustomERC20GatewayWithdrawERC20Event) error) {
	_id := o.ABI.Events["WithdrawERC20"].ID
	o.parsers[_id] = func(log *types.Log) error {
		event := new(L2CustomERC20GatewayWithdrawERC20Event)
		if err := o.L2CustomERC20GatewayCaller.contract.UnpackLog(event, "WithdrawERC20", *log); err != nil {
			return err
		}
		event.Log = log
		return handler(log, event)
...
func NewL2CustomERC20Gateway(address common.Address, backend bind.ContractBackend) (*L2CustomERC20Gateway, error) {
	...
	sigAbi, err := L2CustomERC20GatewayMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
	...
	return &L2CustomERC20Gateway{
		Name:                           "L2CustomERC20Gateway",
		ABI:                            sigAbi,
		Address:                        address,
		topics:                         topics,
		parsers:                        map[common.Hash]func(log *types.Log) error{},
		L2CustomERC20GatewayCaller:     L2CustomERC20GatewayCaller{contract: contract},
		L2CustomERC20GatewayTransactor: L2CustomERC20GatewayTransactor{contract: contract},
	}, nil
}
...
func bindL2CustomERC20Gateway(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(L2CustomERC20GatewayMetaData.ABI))
	if err != nil {
		return nil, err
	}
...
func (_L2CustomERC20Gateway *L2CustomERC20GatewayCaller) RateLimiter(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _L2CustomERC20Gateway.contract.Call(opts, &out, "rateLimiter")
...
func (_L2CustomERC20Gateway *L2CustomERC20GatewayTransactor) UpdateRateLimiter(opts *bind.TransactOpts, _newRateLimiter common.Address) (*types.Transaction, error) {
	return _L2CustomERC20Gateway.contract.Transact(opts, "updateRateLimiter", _newRateLimiter)
}
...
type L2CustomERC20GatewayFinalizeDepositERC20Event struct {
...
type L2CustomERC20GatewayInitializedEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
...
type L2CustomERC20GatewayOwnershipTransferredEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
...
// L2CustomERC20GatewayUpdateRateLimiter represents a UpdateRateLimiter event raised by the L2CustomERC20Gateway contract.
type L2CustomERC20GatewayUpdateRateLimiterEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
...
type L2CustomERC20GatewayUpdateTokenMappingEvent struct {
	Log *types.Log `json:"-" gorm:"-"`
...
type L2CustomERC20GatewayWithdrawERC20Event struct {
	Log *types.Log `json:"-" gorm:"-"`
